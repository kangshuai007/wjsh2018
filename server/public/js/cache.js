...
layui.use(['form','jquery',"layer"],function() {
    ...
    function showNotice(){
        layer.open({
            ...
            btn: ['我已阅读'],
            moveType: 1,
            content: '<div style="padding:15px 20px; text-align:justify; line-height: 22px; text-indent:2em;border-bottom:1px solid #e2e2e2;"><p class="layui-red">此后台管理系统为《吾匠书画小程序》专有后台,</p></pclass></p><p>1.0版本发布以后我们会陆续针对后续小程序的更新进行版本的迭代更新，为此给您带来的不便，我们深感抱歉。在此郑重提示：<span class="layui-red">本后台管理系统为吾匠书画版权所有，所有进行篡改或者将数据泄密上传到任何网站，我们都将追究相应的法律责任。</span></p></div>',
