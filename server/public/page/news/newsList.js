layui.use(['form','layer','laydate','table','laytpl'],function(){
    ...
    var tableIns = table.render({
        elem: '#newsList',
        url : '../../../public/index/Article/showArticle',
        cellMinWidth : 95,
        page : true,
        response: {
        ...
        cols : [[
            ...
            {field: 'title', title: '作品标题', width:350},
            {field: 'author', title: '作品作者', align:'center'},
            ...
            {field: 'f_date', title: '发布时间', align:'center', minWidth:110},
...
//-----------------------------------------------------
    ...
    form.on('switch(newsTop)', function(data){
        ...
        $.post("../../../public/index/Article/updateIstop",{id:data.elem.id},function(res){
                if(res.code==200){
                    setTimeout(function(){
                        layer.close(index);
    ...
    $(".delAll_btn").click(function(){
        ...
        if(data.length > 0) {
            ...
            layer.confirm('确定删除选中作品？', {icon: 3, title: '提示信息'}, function (index) {
                 $.post("../../../public/index/Article/delAll",{
    ...
    table.on('tool(newsList)', function(obj){
        ...
        if(layEvent === 'edit'){ //编辑
            ...
            layer.confirm('确定删除此作品？',{icon:3, title:'提示信息'},function(index){
                 $.post('../../../public/index/Article/delArticle',{
             ...
             $.post("../../../public/index/Article/lookArticle",{id:id},function(res){
