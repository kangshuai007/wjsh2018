/**
 * Created by kangshuai on 2018/10/14.
 */
/**
...
layui.use(['form','layer','table','laytpl','jquery'],function(){
    ...
    var tableIns = table.render({
        ...
        cols : [[
            ...
            {field: 'j_date', title: '预定日期', align:'center',minWidth:150},
            {title: '操作', minWidth:175, templet:'#joinInListBar',fixed:"right",align:"center"}
        ]]
    });
    ...
    $(".delAll_btn").click(function(){
        var checkStatus = table.checkStatus('joinInListTable'),
    ...
    //列表操作
    table.on('tool(joinInList1)', function(obj){
